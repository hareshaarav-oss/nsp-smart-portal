import { I as todayIso, S as academicYear, b as putMedia, k as formatLongDate, s as presentVolunteers, u as useNssStore, y as getMedia } from "./utils-BIiJ-s-U.js";
...
import { t as OfficialLetterhead } from "./official-letterhead-0CBv-cY2.js";
import { t as MediaThumb } from "./media-thumb-CiIriRxi.js";
...
import { p as eventPhotoDataUrls } from "./reports-0LItQuD8.js";
import { t as Textarea } from "./textarea-CRsubrpt.js";
import { useEffect, useMemo, useState } from "react";
import { jsx, jsxs } from "react/jsx-runtime";
import { Download, Eye, FileText, Trash2 } from "lucide-react";
import { toast } from "sonner";
//#region src/lib/nss/press.ts
...
//#endregion
//#region src/routes/po/press.tsx?tsr-split=component
function PressPage() {
	const state = useNssStore();
	const events = useMemo(() => [...state.events].sort((a, b) => b.date.localeCompare(a.date)), [state.events]);
	...
	return /* @__PURE__ */ jsxs("div", {
		className: "space-y-6",
		children: [
			/* @__PURE__ */ jsx(OfficialLetterhead, {
				title: "Press report",
				compact: true
			}),
			...
			/* @__PURE__ */ jsxs(Card, {
				...
				children: [/* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, {
					...
					children: [
						...
						pressReports.length ? /* @__PURE__ */ jsx("div", {
							className: "space-y-2",
							children: pressReports.map((r) => /* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("span", {
									...
									children: [/* @__PURE__ */ jsxs(Button, {
										...
										children: [/* @__PURE__ */ jsx(Trash2, {}), "Remove"]
									})]
								})]
							}, r.id))
						}) : /* @__PURE__ */ jsx("p", {
			...
			/* @__PURE__ */ jsxs(Card, { children: [/* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, {
				...
				children: [/* @__PURE__ */ jsx("select", {
					...
					children: events.map((e) => /* @__PURE__ */ jsxs("option", {
						value: e.id,
						children: [
							e.name,
							" — ",
			...
			/* @__PURE__ */ jsxs(Card, { children: [/* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, {
			...
			}) }), /* @__PURE__ */ jsx(CardContent, { children: photos.length === 0 ? /* @__PURE__ */ jsx("p", {
				className: "text-sm text-muted-foreground",
				...
				children: photos.slice(0, 12).map((item) => /* @__PURE__ */ jsxs("div", {
					className: "overflow-hidden rounded-md border border-border",
					children: [/* @__PURE__ */ jsx(MediaThumb, {
						item,
			...
			}) }), /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx(Textarea, {
			...
			/* @__PURE__ */ jsxs(Card, { children: [/* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, {
			...
			}) }), /* @__PURE__ */ jsx(CardContent, { children: present.length === 0 ? /* @__PURE__ */ jsx("p", {
				className: "text-sm text-muted-foreground",
				...
				children: present.map((v) => /* @__PURE__ */ jsxs("li", {
					className: "mb-1",
					children: [
						v.fullName,
						" · ",
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsxs(Button, {
						...
						children: [/* @__PURE__ */ jsx(Eye, {}), "View Gujarati press report"]
					}),
					/* @__PURE__ */ jsxs(Button, {
						variant: "outline",
						onClick: () => void viewNaac(),
						children: [/* @__PURE__ */ jsx(Eye, {}), "View English NAAC report"]
					}),
					/* @__PURE__ */ jsx(Button, {
						variant: "ghost",
						onClick: () => {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(Label, { children: "English NAAC draft (editable)" }), /* @__PURE__ */ jsx(Textarea, {
