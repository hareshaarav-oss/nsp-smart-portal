import { E as daysUntilBirthday, I as todayIso, P as parseDob, a as bestVolunteer, c as rsvpOf, d as volunteerHours, g as compressPassport, i as attendanceOf, j as idCardName, k as formatLongDate, m as blobToDataUrl, u as useNssStore } from "./utils-BIiJ-s-U.js";
import { t as Button } from "./button-HEpMk59d.js";
import { i as CardTitle, n as CardContent, r as CardHeader, t as Card } from "./card-2ADCK2Ma.js";
import { h as useSessionStore, o as findSessionVolunteer, p as registerFingerprint, s as isOfficer } from "./router-Cdyjb-lJ.js";
import { t as AppShell } from "./shell-DsfHbM4s.js";
import { t as Badge } from "./badge-BMh2Hxac.js";
import { t as Input } from "./input-CRT4sBU_.js";
import { t as Label } from "./label-Bl0lQyM7.js";
import { i as openCertificateDocument, n as htmlForCertificate } from "./certificates-BpqtJ9x9.js";
import { t as openIdCard } from "./id-card-BhQsWlP5.js";
			...
			children: [
						...
						children: /* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsxs(Button, {
									...
									children: [/* @__PURE__ */ jsx(CreditCard, {}), "Digital ID Card"]
								}),
								/* @__PURE__ */ jsxs(Button, {
									className: "bg-sky-600 text-white hover:bg-sky-700",
									onClick: () => setPanel(panel === "edit" ? "none" : "edit"),
									children: [/* @__PURE__ */ jsx(Pencil, {}), "Edit Profile"]
								}),
								/* @__PURE__ */ jsxs(Button, {
									className: "bg-forest text-primary-foreground hover:bg-forest/90",
									onClick: () => setPanel(panel === "password" ? "none" : "password"),
									children: [/* @__PURE__ */ jsx(Lock, {}), "Change Password"]
								}),
								/* @__PURE__ */ jsxs(Button, {
									variant: "danger",
									onClick: () => {
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs(Card, {
						className: "shadow-md",
						children: [/* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: "My Attendance & Service Progress" }) }), /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx("div", {
							className: "h-64",
						...
						className: "shadow-md",
						children: [/* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: "My Progress" }) }), /* @__PURE__ */ jsxs(CardContent, {
							className: "space-y-4",
							children: [
								/* @__PURE__ */ jsx(ProgressRow, {
									label: "Attendance",
									value: attPct,
									suffix: "%"
								}),
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("strong", { children: "Achievement badges" }), /* @__PURE__ */ jsxs("div", {
										className: "mt-2 flex flex-wrap gap-2",
										children: [
											present >= 5 ? /* @__PURE__ */ jsx(Badge, {
												tone: "forest",
												children: "Attendance Champion"
											}) : null,
											hours >= 40 ? /* @__PURE__ */ jsx(Badge, {
												tone: "saffron",
												children: "Community Service"
											}) : null,
											hours >= 120 ? /* @__PURE__ */ jsx(Badge, {
												tone: "navy",
												children: "Service Milestone"
											}) : null,
											isBest ? /* @__PURE__ */ jsx(Badge, {
												tone: "saffron",
												children: "Best Volunteer"
											}) : null,
											present === 0 && hours === 0 ? /* @__PURE__ */ jsx("span", {
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("strong", { children: "NSS Impact" }), /* @__PURE__ */ jsx("p", {
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs(Card, { children: [/* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: "Recent Activity Table" }) }), /* @__PURE__ */ jsx(CardContent, {
						...
						children: /* @__PURE__ */ jsxs("table", {
							...
							children: [/* @__PURE__ */ jsx("thead", {
								...
								children: /* @__PURE__ */ jsxs("tr", { children: [
									...
									/* @__PURE__ */ jsx("th", { children: "Hours" })
								] })
							}), /* @__PURE__ */ jsx("tbody", { children: events.filter((e) => myAtt.some((a) => a.eventId === e.id)).sort((a, b) => b.date.localeCompare(a.date)).slice(0, 6).map((e) => {
								...
								return /* @__PURE__ */ jsxs("tr", {
									...
									children: [
										...
										/* @__PURE__ */ jsx("td", { children: formatLongDate(e.date) }),
										/* @__PURE__ */ jsx("td", { children: /* @__PURE__ */ jsx(Badge, {
											tone: r?.present ? "forest" : "danger",
											children: r?.present ? "Present" : "Absent"
										}) }),
										/* @__PURE__ */ jsx("td", { children: r?.present ? e.hours : 0 })
									]
								}, e.id);
							}) })]
						})
					})] }), /* @__PURE__ */ jsxs(Card, { children: [/* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: "Upcoming Events & RSVP" }) }), /* @__PURE__ */ jsx(CardContent, {
						className: "space-y-3",
							...
							return /* @__PURE__ */ jsxs("div", {
								...
								children: [
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx("strong", { children: e.name }), /* @__PURE__ */ jsx(Badge, {
											tone: "saffron",
											children: "Upcoming"
										})]
									}),
				...
				panel === "edit" ? /* @__PURE__ */ jsx(EditProfile, { volunteerId: me.id }) : null,
				panel === "password" ? /* @__PURE__ */ jsxs(Card, { children: [/* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsxs(CardTitle, {
					className: "flex items-center gap-2",
					children: [/* @__PURE__ */ jsx(Lock, { className: "size-4" }), "Change password"]
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(Label, { children: "Current password (registered mobile)" }), /* @__PURE__ */ jsx(Input, {
								type: "password",
								value: cur,
						...
						/* @__PURE__ */ jsxs("div", {
							className: "space-y-1.5",
							children: [/* @__PURE__ */ jsx(Label, { children: "Confirm new password" }), /* @__PURE__ */ jsx(Input, {
								type: "password",
								value: confirm,
					...
					children: [
						...
						/* @__PURE__ */ jsxs("form", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								type: "submit",
								children: [/* @__PURE__ */ jsx(KeyRound, {}), "Save MPIN"]
							})]
						}),
						/* @__PURE__ */ jsxs(Button, {
							type: "button",
							...
							children: [/* @__PURE__ */ jsx(Fingerprint, {}), me.webauthnId ? "Fingerprint enabled — tap to re-link" : "Enable fingerprint login"]
						})
					]
				})] }),
				/* @__PURE__ */ jsxs("div", {
					className: "grid gap-4 lg:grid-cols-2",
					children: [/* @__PURE__ */ jsxs(Card, { children: [/* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: "Latest notices" }) }), /* @__PURE__ */ jsx(CardContent, {
						className: "space-y-3",
						children: myNotices.length === 0 ? /* @__PURE__ */ jsx("p", {
							className: "text-sm text-muted-foreground",
							children: "No notices yet."
						}) : myNotices.map((n) => /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
					...
					})] }), /* @__PURE__ */ jsxs(Card, { children: [/* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: "Upcoming events" }) }), /* @__PURE__ */ jsx(CardContent, {
						className: "space-y-2",
						children: upcoming.length === 0 ? /* @__PURE__ */ jsx("p", {
							className: "text-sm text-muted-foreground",
							children: "No upcoming event."
						}) : upcoming.map((e) => /* @__PURE__ */ jsxs("div", {
				...
				settings.birthdayShowOnDashboard !== false && myBirthday ? /* @__PURE__ */ jsxs(Card, {
					className: "border-saffron/40",
					children: [/* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsxs(CardTitle, {
						className: "flex items-center gap-2",
						children: [/* @__PURE__ */ jsx(Cake, { className: "size-5 text-saffron" }), " My Birthday"]
				...
				/* @__PURE__ */ jsxs(Card, { children: [/* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsxs(CardTitle, {
					className: "flex items-center gap-2",
					children: [/* @__PURE__ */ jsx(Award, { className: "size-4 text-saffron" }), "My earned certificates"]
				}) }), /* @__PURE__ */ jsx(CardContent, {
					className: "space-y-2",
					children: mine.length === 0 ? /* @__PURE__ */ jsx("p", {
						className: "text-sm text-muted-foreground",
						children: "Certificates issued by the Programme Officer will appear here."
					}) : mine.map(({ cert, event }) => /* @__PURE__ */ jsxs("div", {
				...
				/* @__PURE__ */ jsxs(Card, { children: [/* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: "Attendance history" }) }), /* @__PURE__ */ jsx(CardContent, {
					className: "space-y-2",
...
function EditProfile({ volunteerId }) {
	...
	return /* @__PURE__ */ jsxs(Card, { children: [/* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: "Edit profile" }) }), /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsxs("form", {
		className: "grid gap-3 sm:grid-cols-2",
		onSubmit: save,
		children: [
			/* @__PURE__ */ jsxs("div", {
				className: "sm:col-span-2 flex items-center gap-3",
				children: [form.photoUrl ? /* @__PURE__ */ jsx("img", {
					src: form.photoUrl,
					alt: "",
...
function ProgressRow({ label, value, suffix }) {
	return /* @__PURE__ */ jsxs("div", { children: [
		/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx("span", { children: label }), /* @__PURE__ */ jsxs("strong", { children: [value, "%"] })]
		}),
		/* @__PURE__ */ jsx("div", {
