import { I as todayIso, S as academicYear, k as formatLongDate, t as cn, u as useNssStore } from "./utils-BIiJ-s-U.js";
import { t as TricolourStrip } from "./tricolour-DHYPuBOE.js";
import { jsx, jsxs } from "react/jsx-runtime";
//#region src/components/nss/official-letterhead.tsx
function OfficialLetterhead({ title, compact = false, className }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		}), /* @__PURE__ */ jsx(TricolourStrip, { className: "mt-3" })]
	});
}
function ReportPreview({ title, headers, rows, intro, maxRows = 8 }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			intro?.length ? /* @__PURE__ */ jsx("div", {
				className: "space-y-2 border-t border-border px-4 py-3 text-sm leading-relaxed text-navy",
				children: intro.map((p, i) => /* @__PURE__ */ jsx("p", { children: p }, i))
			}) : null,
			headers.length ? /* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs("table", {
					...
					children: [/* @__PURE__ */ jsx("thead", {
						...
						children: /* @__PURE__ */ jsx("tr", { children: headers.map((h) => /* @__PURE__ */ jsx("th", {
							className: "px-2 py-2 font-medium",
							children: h
						}, h)) })
					}), /* @__PURE__ */ jsx("tbody", { children: shown.map((r, i) => /* @__PURE__ */ jsx("tr", {
						className: "border-t border-border",
						children: r.map((c, j) => /* @__PURE__ */ jsx("td", {
			...
			rows.length > maxRows ? /* @__PURE__ */ jsxs("p", {
